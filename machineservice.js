...
app.service('machineService', function($rootScope, $timeout, warningService) {
  ...
  var api = {
    ...
    //abspos:nodeToWriteTo.msg //provo ad aggiungere una variabile
  };
  return api;
 
 //MIO TENTATIVO FALLIMENTARE DI RICAVARE POSZIONE ASSOLUTA
//      $scope.abpos = function() {
  //    return nodeToWriteTo.msg;
    //  } 
